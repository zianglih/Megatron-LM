...
def get_model(model_provider_func, model_type=ModelType.encoder_or_decoder, wrap_with_ddp=True, config=None, pg_collection=None):
    ...
    if wrap_with_ddp:
        ...
        if getattr(args, "use_torch_fsdp2", False):
            ...
            main_grads_dtype = torch.float32 if args.accumulate_allreduce_grads_in_fp32 else args.main_grads_dtype
            grad_accum_dtype = torch.float32 if args.accumulate_allreduce_grads_in_fp32 else args.megatron_fsdp_grad_accum_dtype
